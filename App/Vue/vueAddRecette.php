...
<form action="/projetSite/recetteadd" method="post" id="form1" enctype="multipart/form-data">
    ...
    <div class="radio-container">
        ...
        <div class="radio-group">
            <input type="radio" id="debutant" name="niveau_recette" value="debutant"> <label for="debutant">
                Débutant</label>
            <input type="radio" id="intermediaire" name="niveau_recette" value="intermediaire"> <label
                for="intermediaire">Intermédiaire</label>
    ...
    <textarea id="description_recette" name="description_recette" placeholder="Ex: Faire fondre le chocolat" rows="12"
        cols="35"></textarea>
    ...
    <button type="submit" name="submit" class="formbtn"> SOUMETTRE LA RECETTE </button>
</form>
<p>
    <?= $error ?>
</p>
